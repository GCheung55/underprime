...
function _template(text, data, options) {
    ...
    var imports = options.imports || {escape: escape}
    var importsKeys = imports ? keys(imports) : []
    var importsValues = imports ? values(imports) : []
